        ...
        <div class="tab-pane active" id="mmenu-users">
            ...
            <ul class="users-list">
                ...
                <li class="online">
                    <div class="media">
                        <a class="pull-left profile-photo" href="#">
                            <img class="media-object" src="/img/admin/ici-avatar.jpg" alt>
                        </a>
                ...
                <li class="online">
                    <div class="media">
                        ...
                        <a class="pull-left profile-photo" href="#">
                            <img class="media-object" src="/img/admin/arnold-avatar.jpg" alt>
                        </a>
                ...
                <li class="online">
                    <div class="media">
                        <a class="pull-left profile-photo" href="#">
                            <img class="media-object" src="/img/admin/peter-avatar.jpg" alt>
                ...
                <li class="online">
                    <div class="media">
                        <a class="pull-left profile-photo" href="#">
                            <img class="media-object" src="/img/admin/george-avatar.jpg" alt>
                        </a>
                        <div class="media-body">
                ...
                <li class="busy">
                    <div class="media">
                        <a class="pull-left profile-photo" href="#">
                            <img class="media-object" src="/img/admin/random-avatar1.jpg" alt>
                        </a>
                        <div class="media-body">
                ...
                <li class="busy">
                    <div class="media">
                        <a class="pull-left profile-photo" href="#">
                            <img class="media-object" src="/img/admin/random-avatar2.jpg" alt>
                        </a>
                        <div class="media-body">
            ...
            <ul class="users-list">
                ...
                <li class="offline">
                    <div class="media">
                        <a class="pull-left profile-photo" href="#">
                            <img class="media-object" src="/img/admin/random-avatar4.jpg" alt>
                        </a>
                        <div class="media-body">
                ...
                <li class="offline">
                    <div class="media">
                        ...
                        <a class="pull-left profile-photo" href="#">
                            <img class="media-object" src="/img/admin/random-avatar5.jpg" alt>
                        </a>
                ...
                <li class="offline">
                    <div class="media">
                        <a class="pull-left profile-photo" href="#">
                            <img class="media-object" src="/img/admin/random-avatar6.jpg" alt>
                ...
                <li class="offline">
                    <div class="media">
                        <a class="pull-left profile-photo" href="#">
                            <img class="media-object" src="/img/admin/random-avatar7.jpg" alt>
                        </a>
                        <div class="media-body">
                ...
                <li class="offline">
                    <div class="media">
                        <a class="pull-left profile-photo" href="#">
                            <img class="media-object" src="/img/admin/random-avatar8.jpg" alt>
                        </a>
                        <div class="media-body">
