    ...
    <ul class="dropdown-menu wide arrow nopadding bordered">
        ...
        <li>
            <a href="#">
                ...
                <div class="progress progress-striped progress-thin">
                    <div class="progress-bar progress-bar-green" role="progressbar" aria-valuenow="40" aria-valuemin="0"
        ...
        <li>
            <a href="#">
                ...
                <div class="progress progress-striped active progress-thin">
                    <div class="progress-bar progress-bar-cyan" role="progressbar" aria-valuenow="45" aria-valuemin="0"
        ...
        <li>
            <a href="#">
                ...
                <div class="progress progress-striped progress-thin">
                    <div class="progress-bar progress-bar-red" role="progressbar" aria-valuenow="45" aria-valuemin="0"
...
<li class="dropdown divided">
    ...
    <ul class="dropdown-menu wider arrow nopadding messages">
        ...
        <li>
            <a class="cyan" href="#">
                <div class="profile-photo">
                    <img src="/img/admin/ici-avatar.jpg" alt/>
                </div>
                <div class="message-info">
                    <span class="sender">Ing. Imrich Kamarel</span>
                    <span class="time">12 mins</span>

                    <div class="message-content">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum
                    </div>
                </div>
            </a>
        </li>
        ...
        <li>
            <a class="green" href="#">
                <div class="profile-photo">
                    <img src="/img/admin/arnold-avatar.jpg" alt/>
                </div>
                <div class="message-info">
        ...
        <li>
            <a href="#">
                <div class="profile-photo">
                    <img src="/img/admin/profile-photo.jpg" alt/>
                </div>
                <div class="message-info">
                    <span class="sender">John Douey</span>
                    <span class="time">3 hours</span>

                    <div class="message-content">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui
                        officia
                    </div>
                </div>
            </a>
        ...
        <li>
            <a class="red" href="#">
                <div class="profile-photo">
                    <img src="/img/admin/peter-avatar.jpg" alt/>
                </div>
                <div class="message-info">
        ...
        <li>
            <a class="orange" href="#">
                <div class="profile-photo">
                    <img src="/img/admin/george-avatar.jpg" alt/>
                </div>
                <div class="message-info">
    ...
    <ul class="menu">
        ...
        <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <i class="fa fa-list"></i> 鹦鹉管理 <b class="fa fa-plus dropdown-plus"></b>
            </a>
